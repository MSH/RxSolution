...
type
  ...
  TRequisitionDetailFrm = class(TForm)
    ...
    atnImportHospOrderFile: TAction;
    ImportOrderFile1: TMenuItem;
    Button2: TButton;
    ...
    procedure atnImportHospOrderFileExecute(Sender: TObject);
...
procedure TRequisitionDetailFrm.atnImportHospOrderFileExecute(
  Sender: TObject);
begin
 RequisitionDM.ImportDDVRequisition;
end;
