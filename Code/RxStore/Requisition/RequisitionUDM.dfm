object RequisitionDM: TRequisitionDM
  ...
  object qryCheckVoucher: TADOQuery
    Connection = ADORequisitionConnection
    CursorType = ctStatic
    Parameters = <
      item
    ...
    SQL.Strings = (
      ...
      '      VoucherNo_str'
      'FROM TblRequisition'
      'WHERE VoucherNo_str = :voucher')
    Left = 1252
    Top = 347
  end
  object qryGetDemanderID: TADOQuery
    Connection = ADORequisitionConnection
    CursorType = ctStatic
    Parameters = <
      item
    ...
    SQL.Strings = (
      'SELECT DISTINCT Demander_ID      '
      '  FROM tblDemander'
      'WHERE Code_str = :code')
    Left = 1256
    Top = 410
  end
  object qryGetProductsWithNSN: TADOQuery
    Connection = ADORequisitionConnection
    CursorType = ctStatic
    Parameters = <
      item
    ...
    SQL.Strings = (
      'SELECT DISTINCT ProductCode_ID      '
