object ProductBatchSelectFrm: TProductBatchSelectFrm
  Left = 367
  Top = 209
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Available Product Batches'
  ClientHeight = 486
  ClientWidth = 864
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object dxDBGrid1: TdxDBGrid
      ...
      BandFont.Style = []
      DataSource = RequisitionDM.dstmpItems
      ...
      LookAndFeel = lfFlat
      OptionsBehavior = [edgoDragScroll, edgoEditing, edgoEnterShowEditor, edgoEnterThrough, edgoImmediateEditor, edgoMultiSort, edgoStoreToRegistry, edgoTabs, edgoTabThrough, edgoVertThrough]
      ...
      object dxDBGrid1ProductBatch_ID: TdxDBGridMaskColumn
        DisableEditor = True
        TabStop = False
        Visible = False
        Width = 2007
      ...
      object dxDBGrid1ProductCode_ID: TdxDBGridColumn
        TabStop = False
        Visible = False
        BandIndex = 0
        RowIndex = 0
      ...
      object dxDBGrid1QtyIssued_int: TdxDBGridColumn
        Caption = 'Qty Issued'
        BandIndex = 0
        RowIndex = 0
        OnChange = dxDBGrid1QtyIssued_intChange
        FieldName = 'QtyIssued_int'
        SummaryFooterType = cstSum
        SummaryFooterField = 'QtyIssued_int'
        SummaryFooterFormat = '0'
        SummaryField = 'QtyIssued_int'
        SummaryGroupName = 'Total Issued:'
      end
      object dxDBGrid1BatchQty: TdxDBGridColumn
        Caption = 'On Hand'
        DisableEditor = True
        BandIndex = 0
        RowIndex = 0
  ...
  object Panel3: TPanel
    ...
    object Label3: TLabel
      ...
      Width = 186
      Height = 16
      Caption = 'Available to issue for this batch:'
    end
  end
  object ActionList1: TActionList
    ...
    object atnDataSetPost: TDataSetPost
      Category = 'Dataset'
      Caption = 'P&ost'
      Hint = 'Post'
      ImageIndex = 7
    ...
    object atnDataSetCancel: TDataSetCancel
      Category = 'Dataset'
      Caption = '&Cancel'
      Hint = 'Cancel'
      ImageIndex = 8
    ...
    object atnPostRecord: TAction
      Caption = 'atnPostRecord'
      OnExecute = atnPostRecordExecute
    end
    object atnCancelReceord: TAction
      Caption = 'atnCancelReceord'
      OnExecute = atnCancelReceordExecute
    end
  end
  ...
  object stpRemveItems: TADOQuery
    ...
    SQL.Strings = (
      'DELETE FROM tblRequisitionItems'
      'WHERE requisition_ID=:RequisitionID'
      'AND ProductBatch_ID=:ProductBatchID')
    Left = 472
    Top = 352
  end
  object qryTotalIssued: TADOQuery
    Connection = RequisitionDM.ADORequisitionConnection
    Parameters = <
      item
        Name = 'RequisitionID'
    ...
    SQL.Strings = (
      'SELECT SUM(tblRequisitionItems.QtyIssued_int) AS TotQtyIssued'
      'FROM tblRequisitionItems'
      'INNER JOIN '
      'tblProductBatch '
      
        'ON tblProductBatch.ProductBatch_ID = tblRequisitionItems.Product' +
        'Batch_ID'
