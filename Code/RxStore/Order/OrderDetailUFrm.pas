...
type
  TOrderDetailFrm = class(TForm)
    ...
    cmdAuthorisedBy: TwwDBLookupCombo;
    wwDBDateTimePicker1: TwwDBDateTimePicker;
    dateAuthorizedBy: TwwDBDateTimePicker;
    ...
    dxgOrders_ItemsVEN_str: TdxDBGridColumn;
...
begin
  ...
  cmdAuthorisedBy.Enabled := vAccessLevel > USER_USER;
  dateAuthorizedBy.Enabled := vAccessLevel > USER_USER;
  ...
  //********* SM May 2015
  //********* System: Check if Order Authorisation is being used.
  USeAuthorise := MainDm.UseOrdersAuthorisation;

  CanAuthorise := ((not isPosted) AND (vAccessLevel > USER_USER));
  btnAuthorise.Enabled := CanAuthorise;
  btnAuthorise.Visible := USeAuthorise;
  cmdAuthorisedBy.Enabled := (not USeAuthorise);
  dateAuthorizedBy.Enabled := (not USeAuthorise);
...
begin
  ...
  dateAuthorizedBy.MinDate := wwDBDateTimePicker1.Date;
...
procedure TOrderDetailFrm.Button2Click(Sender: TObject);
begin
//

end;

procedure TOrderDetailFrm.btnAuthoriseClick(Sender: TObject);
begin
 //
 OrderDM.AuthoriseOrder;
end;
