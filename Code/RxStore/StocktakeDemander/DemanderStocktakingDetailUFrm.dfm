object DemanderStocktakingDetailFrm: TDemanderStocktakingDetailFrm
  Left = 274
  Top = 136
  Width = 1392
  Height = 847
  ...
  object Panel4: TPanel
    ...
    object btnClose: TButton
      ...
      Width = 92
      Height = 31
      Action = DemanderStocktakingDM.atnSaveAndClose
  ...
  object Panel1: TPanel
    ...
    object pnlHeaderBackground: TPanel
      ...
      object lblDate: TDBText
        ...
        DataSource = DemanderStocktakingDM.dsStocktakeWorker
        Font.Charset = ANSI_CHARSET
        Font.Color = clHighlight
        Font.Height = -15
        Font.Name = 'Tahoma'
      ...
      object btnPostClose: TButton
        ...
        Width = 188
        Height = 49
        Action = DemanderStocktakingDM.atnPostAndClose
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Height = -15
        Font.Name = 'MS Sans Serif'
      ...
      object RzDBLookupComboBox3: TRzDBLookupComboBox
        ...
        ListField = 'Code_str'
        ListSource = DemanderStocktakingDM.dsDemandersFrom
        ParentCtl3D = False
        ParentFont = False
        TabOrder = 0
      ...
      object RzDBLookupComboBox4: TRzDBLookupComboBox
        ...
        KeyField = 'Demander_ID'
        ListField = 'Name_str'
        ListSource = DemanderStocktakingDM.dsDemandersNames
        ParentCtl3D = False
        ParentFont = False
        TabOrder = 1
        DisabledColor = clSilver
      ...
      object cmbStockCapturedBy_str: TwwDBLookupCombo
        ...
        DataSource = DemanderStocktakingDM.dsStocktakeWorker
        LookupTable = DemanderStocktakingDM.qryDemanderUsers
        LookupField = 'personDescription_str'
  ...
  object Panel3: TPanel
    ...
    object ElSpeedButton5: TElSpeedButton
      ...
      Color = clBtnFace
      ParentColor = False
      Action = DemanderStocktakingDM.atnDeleteItem
      DockOrientation = doNoOrient
    end
    object ElSpeedButton6: TElSpeedButton
      ...
      Color = clBtnFace
      ParentColor = False
      Action = DemanderStocktakingDM.atnAddSingleItem
      DockOrientation = doNoOrient
    end
    object ElSpeedButton13: TElSpeedButton
      ...
      Color = clBtnFace
      ParentColor = False
      Action = DemanderStocktakingDM.DataSetPost1
      DockOrientation = doNoOrient
    end
    object ElSpeedButton16: TElSpeedButton
      ...
      Color = clBtnFace
      ParentColor = False
      Action = DemanderStocktakingDM.DataSetCancel1
      DockOrientation = doNoOrient
    end
  end
  object PageTakeItems: TRzPageControl
    ...
    object tbsItems: TRzTabSheet
      Color = clWhite
      Caption = 'Details'
      object dxStocktakeDemanderItems: TdxDBGrid
        Left = 0
        Top = 0
        Width = 1374
        Height = 469
        ...
        KeyField = 'StockTakeDemanderItem_ID'
        ShowGroupPanel = True
        ...
        BandFont.Style = []
        DataSource = DemanderStocktakingDM.dsStocktakeItems
        ...
        PreviewFont.Style = []
        RegistryPath = 
          '\Software\RxSolution\1.2\Grids\StocktakeDemander\dxStocktakeDema' +
          'nderItems'
        RowFooterColor = clHighlight
        RowFooterTextColor = clWindow
        Anchors = [akLeft, akTop, akRight]
        object dxStocktakeDemanderItemsICN_str: TdxDBGridColumn
          Caption = 'ICN'
          DisableEditor = True
          Width = 100
          BandIndex = 0
        ...
        object dxStocktakeDemanderItemsNSN_str: TdxDBGridColumn
          Caption = 'NSN'
          DisableEditor = True
          Visible = False
          Width = 174
        ...
        object dxStocktakeDemanderItemsECN_str: TdxDBGridColumn
          Caption = 'ECN'
          DisableEditor = True
          Width = 109
          BandIndex = 0
        ...
        object dxStocktakeDemanderItemsDescription_str: TdxDBGridMaskColumn
          Caption = 'Description'
          DisableEditor = True
          Width = 352
          BandIndex = 0
        ...
        object dxStocktakeDemanderItemsPackCost_mon: TdxDBGridCurrencyColumn
          Caption = 'Pack Cost'
          Width = 130
          BandIndex = 0
          RowIndex = 0
        ...
        object dxStocktakeDemanderItemsFullPackQty_int: TdxDBGridMaskColumn
          Caption = 'Full Pack Qty'
          Width = 83
          BandIndex = 0
          RowIndex = 0
          FieldName = 'FullPackQty_int'
        end
        object dxStocktakeDemanderItemsBrokenPackQty_dbl: TdxDBGridMaskColumn
          Caption = 'Broken Pack Qty'
          Width = 105
          BandIndex = 0
          RowIndex = 0
          FieldName = 'BrokenPackQty_dbl'
        end
        object dxStocktakeDemanderItemsExtendedCost_mon: TdxDBGridCurrencyColumn
    ...
    object tbsHistory: TRzTabSheet
      ...
      object dxStocktakeDemanderHistory: TdxDBGrid
        Left = 0
        Top = 0
        Width = 1372
        Height = 518
        ...
        DefaultLayout = False
        HeaderPanelRowCount = 1
        KeyField = 'StockTakeDemanderHistory_ID'
        ShowGroupPanel = True
        SummaryGroups = <>
        SummarySeparator = ', '
        Align = alClient
        ...
        BandFont.Name = 'MS Sans Serif'
        BandFont.Style = []
        DataSource = DemanderStocktakingDM.dsEditHistory
        Filter.Active = True
        Filter.DropDownCount = 16
        Filter.Criteria = {00000000}
        GridLineColor = clInactiveCaptionText
        ...
        RowFooterColor = clHighlight
        RowFooterTextColor = clWindow
        object dxStocktakeDemanderHistoryDate_dat: TdxDBGridDateColumn
          Caption = 'Date'
          DisableEditor = True
          Sorted = csDown
          Width = 117
        ...
        object dxStocktakeDemanderHistoryDescription_str: TdxDBGridMaskColumn
          Caption = 'Description'
          DisableEditor = True
          Width = 762
          BandIndex = 0
        ...
        object dxStocktakeDemanderHistoryType_str: TdxDBGridMaskColumn
          Caption = 'Type'
          DisableEditor = True
          Width = 77
          BandIndex = 0
        ...
        object dxStocktakeDemanderHistoryUserName_str: TdxDBGridMaskColumn
          Caption = 'User Name'
          DisableEditor = True
          Width = 226
          BandIndex = 0
  ...
  object PopupMenu1: TPopupMenu
    ...
    object AddDemanderItems1: TMenuItem
      Action = DemanderStocktakingDM.AtnAddDemanderItems
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object RemoveAllItems1: TMenuItem
      Action = DemanderStocktakingDM.atnDeleteAllItems
    end
  end
  ...
  object PopMenuPrint: TPopupMenu
    Left = 848
    Top = 176
    object PrintMainReport1: TMenuItem
      Action = DemanderStocktakingDM.atnPrintMainReport
      AutoHotkeys = maManual
    end
    object PrintAnomalies1: TMenuItem
      Action = DemanderStocktakingDM.atnPrintDifferences
    end
  end
end
