object ReceiptDetailFrm: TReceiptDetailFrm
  Left = 248
  Top = 157
  Width = 1573
  Height = 845
  BorderIcons = []
  Caption = 'Receipt - Add/Edit/Delete Products'
  Color = clWhite
  ...
  object pnlReceiptHeaderBackground: TPanel
    ...
    object dbtActivated_dat: TDBText
      Left = 80
      Top = 142
      Width = 106
      Height = 23
    ...
    object dbtActivatedBy_str: TDBText
      Left = 80
      Top = 166
      Width = 106
      Height = 24
    ...
    object DBText9: TDBText
      ...
      Alignment = taRightJustify
      Color = 16644340
      DataField = 'CountOfReceiptItem_ID'
      DataSource = ReceiptDm.dsstpStockControlReceiptItemsTotals
      Font.Charset = ANSI_CHARSET
      Font.Color = clHighlight
      Font.Height = -15
      Font.Name = 'MS Sans Serif'
    ...
    object lblTypeDisplay: TLabel
      Left = 1410
      Top = 68
      Width = 140
      Height = 23
      Hint = 'Right click to change|Right click to change'
      Anchors = [akTop, akRight]
      AutoSize = False
      Caption = 'lblTypeDisplay'
      Color = 16644340
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
    ...
    object wwDBLookupCombo3: TwwDBLookupCombo
      ...
      DataSource = ReceiptDm.dsstpStockControlReceipt
      LookupTable = ReceiptDm.tblSystemUsers
    ...
    object dxDBCurrencyEdit3: TdxDBCurrencyEdit
      ...
      Alignment = taRightJustify
      AutoSize = False
      DataField = 'SumOfExtendedCost_mon'
      DataSource = ReceiptDm.dsstpStockControlReceiptItemsTotals
      ReadOnly = True
      StyleController = dxEditStyle_NoBorder
      DisplayFormat = ' ,0.000;- ,0.000'
      Nullable = False
      Height = 29
      StoredValues = 65
    end
    object dxeCharges_mon: TdxDBCurrencyEdit
      Left = 1410
      Top = 139
      Width = 142
      Cursor = crHandPoint
    ...
    object dbcActivated_bol: TDBCheckBox
      Left = 537
      Top = 4
      Width = 149
      Height = 23
      Caption = 'Post Receipt'
      DataField = 'Activated_bol'
      DataSource = ReceiptDm.dsstpStockControlReceipt
      Font.Charset = ANSI_CHARSET
      Font.Color = clHighlight
      Font.Height = -15
    ...
    object dbcIncludeVAT: TDBCheckBox
      Left = 714
      Top = 4
      Width = 109
      Height = 23
      Caption = 'VAT'
      DataField = 'IncludeVat_bol'
      DataSource = ReceiptDm.dsstpStockControlReceipt
      Font.Charset = ANSI_CHARSET
      Font.Color = clHighlight
      Font.Height = -15
    ...
    object rzlSupplierName: TRzDBLookupComboBox
      Left = 465
      Top = 68
      Width = 869
      Height = 24
      ...
      ListField = 'Name_str'
      ListSource = ReceiptDm.dstblReceiptListUniqueSuppliersNames
      ParentCtl3D = False
      TabOrder = 13
      FrameController = RzFrameController1
      FramingPreference = fpCustomFraming
    end
    object rzlSystemStore: TRzDBLookupComboBox
      Left = 465
      Top = 92
      Width = 869
      Height = 24
      Anchors = [akLeft, akTop, akRight]
      Ctl3D = False
      DataField = 'SystemStore_ID'
      DataSource = ReceiptDm.dsstpStockControlReceipt
      KeyField = 'SystemAccount_ID'
      ListField = 'AccountName_str'
      ListSource = ReceiptDm.dstblSystemWharehouseNames
      ParentCtl3D = False
      TabOrder = 15
      FrameController = RzFrameController1
      FramingPreference = fpCustomFraming
    end
    object rzlSystemStoreCode: TRzDBLookupComboBox
      Left = 305
      Top = 92
      Width = 159
      Height = 24
      ...
      ListSource = ReceiptDm.dstblSystemWharehouse
      ParentCtl3D = False
      TabOrder = 14
      FrameController = RzFrameController1
      FramingPreference = fpCustomFraming
    end
    object rzlReferenceString: TRzDBLookupComboBox
      Left = 471
      Top = 41
      Width = 614
      Height = 24
      Anchors = [akLeft, akTop, akRight]
      Ctl3D = False
      DataField = 'OrderNo_ID'
      DataSource = ReceiptDm.dsstpStockControlReceipt
      KeyField = 'OrderNo_ID'
      ListField = 'Description'
      ListFieldIndex = -1
      ListSource = ReceiptDm.dstblStockControlReceiptItemsAvailableOrdersDecriptionLookup
      ParentCtl3D = False
      TabOrder = 11
      OnCloseUp = rzlReferenceStringCloseUp
      FrameController = RzFrameController1
      FramingPreference = fpCustomFraming
    end
    object rzlReferenceNumber: TRzDBLookupComboBox
      Left = 305
      Top = 41
      Width = 165
      Height = 24
      ...
      DropDownWidth = 250
      KeyField = 'OrderNo_ID'
      ListField = 'OrderNo_str'
      ListFieldIndex = -1
      ListSource = ReceiptDm.dstblStockControlReceiptItemsAvailableOrders
      ParentCtl3D = False
      TabOrder = 9
      OnCloseUp = rzlReferenceNumberCloseUp
      FrameController = RzFrameController1
      FramingPreference = fpCustomFraming
    end
    object rzlSupplierCode: TRzDBLookupComboBox
      Left = 305
      Top = 68
      Width = 159
      Height = 24
      ...
      KeyField = 'Supplier_ID'
      ListField = 'Code_str'
      ListSource = ReceiptDm.dstblReceiptListUniqueSuppliers
      ParentCtl3D = False
      TabOrder = 10
      FrameController = RzFrameController1
      FramingPreference = fpCustomFraming
    end
    object RzlVoucherNo_str: TRzDBLookupComboBox
      Left = 1145
      Top = 41
      Width = 189
      Height = 24
      ...
      DataSource = ReceiptDm.dsstpStockControlReceipt
      KeyField = 'OrderNo_ID'
      ListField = 'VoucherNo_str'
      ListFieldIndex = -1
      ListSource = ReceiptDm.dstblStockControlReceiptItemsAvailableOrders
      ParentCtl3D = False
      TabOrder = 12
      OnCloseUp = RzlVoucherNo_strCloseUp
      FrameController = RzFrameController1
      FramingPreference = fpCustomFraming
    end
    object dbeDemander: TDBEdit
      Left = 305
      Top = 191
      Width = 1027
      Height = 23
  ...
  object dxTbctrlReceiptDetail: TdxPageControl
    Left = 0
    Top = 216
    Width = 1557
    Height = 509
    ...
    TabPosition = dxtpTop
    TabWidth = 0
    object dxTbsReceipt_Items: TdxTabSheet
      Caption = 'Items'
      object Panel3: TPanel
        ...
        object lblAddBatch: TButton
          Left = 386
          Top = 1
          Width = 255
          Height = 29
          Action = atnAddDiffBatchItem
          TabOrder = 2
        end
      ...
      object dxDBReceipt_Itemss: TdxDBGrid
        ...
        PreviewFont.Style = []
        RegistryPath = '\Software\RxSolution\1.2\Grids\Receipt\Detail'
        RowFooterColor = clHighlight
        RowFooterTextColor = clWindow
        object dxDBReceipt_ItemssProductCode_str: TdxDBGridMaskColumn
          Caption = 'Code'
          DisableEditor = True
          Visible = False
          Width = 176
        ...
        object dxDBReceipt_ItemssQtyOrdered_int: TdxDBGridMaskColumn
          Caption = 'Qty Ord'
          DisableEditor = True
          Width = 122
          BandIndex = 0
        ...
        object dxDBReceipt_ItemssOrder_QtyOutstanding: TdxDBGridMaskColumn
          Caption = 'Qty Out'
          DisableEditor = True
          Width = 90
          BandIndex = 0
        ...
        object dxDBReceipt_ItemssQtyToFollow_int: TdxDBGridMaskColumn
          Caption = 'Qty To Follow'
          Visible = False
          Width = 527
          BandIndex = 0
          RowIndex = 0
        ...
        object dxDBReceipt_ItemssBin_str: TdxDBGridPickColumn
          Caption = 'Bin'
          DisableEditor = True
          Width = 46
          BandIndex = 0
        ...
        object dxDBReceipt_ItemssCompleted_bol: TdxDBGridCheckColumn
        ...
        object dxDBReceipt_ItemssExtendedCost_mon: TdxDBGridCurrencyColumn
          Caption = 'TOTAL'
          DisableEditor = True
          Width = 47
          BandIndex = 0
        ...
        object dxDBReceipt_ItemssVoucherNo_str: TdxDBGridColumn
          Caption = 'Line Number'
          Visible = False
          Width = 926
          BandIndex = 0
        ...
        object dxDBReceipt_ItemssShippingPack_int: TdxDBGridColumn
        ...
        object dxDBReceipt_ItemssCalc_PackCost_mon: TdxDBGridCurrencyColumn
          Caption = 'Cost Price'
          Width = 180
          BandIndex = 0
          RowIndex = 0
    ...
    object dxTbsReceipt_Notes: TdxTabSheet
      Caption = 'Notes'
      object dxDBMmRemarks: TdxDBMemo
        Left = 0
        Top = 0
        Width = 1557
        Align = alClient
    ...
    object dxTbsReceipt_History: TdxTabSheet
      Caption = 'History'
      object dxDBReceiptHistory: TdxDBGrid
        Left = 0
        Top = 0
        Width = 1557
        Height = 483
        ...
        BandFont.Name = 'MS Sans Serif'
        BandFont.Style = []
        DataSource = ReceiptDm.dsstpReceiptEditHistory
        Filter.Active = True
        Filter.DropDownCount = 16
        Filter.Criteria = {00000000}
        GridLineColor = clInactiveCaptionText
        ...
        IndentDesc = 10
        LookAndFeel = lfFlat
        OptionsBehavior = [edgoAutoSearch, edgoAutoSort, edgoCaseInsensitive, edgoDragScroll, edgoEditing, edgoEnterShowEditor, edgoImmediateEditor, edgoMultiSort, edgoShowHourGlass, edgoStoreToRegistry, edgoTabs, edgoTabThrough, edgoVertThrough]
        ...
        PreviewFont.Name = 'MS Sans Serif'
        PreviewFont.Style = []
        RegistryPath = '\Software\RxSolution\1.2\Grids\Receipt\History'
        RowFooterColor = clHighlight
        RowFooterTextColor = clWindow
        object dxDBReceiptHistorydate_dat: TdxDBGridDateColumn
          Caption = 'Date'
          DisableEditor = True
          Width = 124
          BandIndex = 0
        ...
        object dxDBReceiptHistoryType_str: TdxDBGridMaskColumn
          Caption = 'Type'
          DisableEditor = True
          Width = 104
          BandIndex = 0
        ...
        object dxDBReceiptHistoryDescription_str: TdxDBGridMaskColumn
          Caption = 'Description'
          DisableEditor = True
          Width = 525
          BandIndex = 0
        ...
        object dxDBReceiptHistoryUserName_str: TdxDBGridMaskColumn
          Caption = 'User'
          DisableEditor = True
          Width = 156
          BandIndex = 0
  ...
  object ActionList1: TActionList
    Left = 176
    Top = 8
    object atnItemsFirst: TDataSetFirst
    ...
    object atnItemsPrior: TDataSetPrior
      Category = 'Dataset Navigation'
      Caption = '&Prior'
      Hint = 'Prior'
      ImageIndex = 1
    ...
    object atnItemsNext: TDataSetNext
      Category = 'Dataset Navigation'
      Caption = '&Next'
      Hint = 'Next'
      ImageIndex = 2
    ...
    object atnItemsLast: TDataSetLast
      Category = 'Dataset Navigation'
      Caption = '&Last'
      Hint = 'Last'
      ImageIndex = 3
    ...
    object atnItemsPost: TDataSetPost
      Category = 'Dataset'
      Caption = 'S&ave'
      Hint = 'Post'
      ImageIndex = 7
    ...
    object atnItemsCancel: TDataSetCancel
      Category = 'Dataset'
      Caption = '&Cancel'
      Hint = 'Cancel'
      ImageIndex = 8
    ...
    object atnItemsRefresh: TDataSetRefresh
      Category = 'Dataset'
    ...
    object atnItemsPageUp: TAction
      Category = 'Dataset Navigation'
      Caption = 'Page &Up'
      OnExecute = atnItemsPageUpExecute
    end
    object atnItemsPageDown: TAction
      Category = 'Dataset Navigation'
      Caption = 'Page Do&wn'
      OnExecute = atnItemsPageDownExecute
    end
    object atnItemsGenerateFromOrder: TAction
      Category = 'Dataset'
      Caption = '&Generate (From Purchase Order Reference)'
      OnExecute = atnItemsGenerateFromOrderExecute
    end
    object atnToggleDisplay: TAction
      Caption = 'atnToggleDisplay'
    end
    object atnItemsMarkAllItemsAsComplete: TAction
      Category = 'Dataset'
      Caption = '&Mark all as Complete'
      ShortCut = 16461
      OnExecute = atnItemsMarkAllItemsAsCompleteExecute
    end
    object atnDisplayCols: TAction
      Caption = 'atnDisplayCols'
      OnExecute = atnDisplayColsExecute
    end
    object atnItemsGenerateFromOrderWithQty: TAction
      Category = 'Dataset'
      Caption = 'Generate &Quantities'
      OnExecute = atnItemsGenerateFromOrderWithQtyExecute
    end
    object atnAddDiffBatchItem: TAction
      Caption = 'Add Different Batch Item (F2)'
      ShortCut = 113
      OnExecute = atnAddDiffBatchItemExecute
    end
    object atnPrintReceipt: TAction
      Category = 'Printing'
      Caption = 'Print selected &Receiving Report'
      OnExecute = atnPrintReceiptExecute
    end
    object atnPrintReceiptOutstanding: TAction
      Category = 'Printing'
      Caption = 'Print selected receiving report &Outstanding Items'
      OnExecute = atnPrintReceiptOutstandingExecute
    end
    object atnCaptureBarCodes: TAction
      Caption = 'Capture Bar Codes [F3]'
      ShortCut = 114
      OnExecute = atnCaptureBarCodesExecute
    end
    object atnUpdateAllReceivedBatches: TAction
      Caption = 'Check all Received'
      OnExecute = atnUpdateAllReceivedBatchesExecute
    end
    object atnCreatePMPUTextFile: TAction
      Caption = 'GRV Text File'
      OnExecute = atnCreatePMPUTextFileExecute
    end
  end
  object PopupMenu1: TPopupMenu
    ...
    object Generate1: TMenuItem
      Action = atnItemsGenerateFromOrder
      Caption = '&Generate Receipt From Purchase Order Reference'
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object Markallascomplete1: TMenuItem
      Action = atnItemsMarkAllItemsAsComplete
    end
    object addanotherbatchitem1: TMenuItem
      Action = atnAddDiffBatchItem
    end
    object N2: TMenuItem
      Caption = '-'
    end
    object atnCaptureBarCodes1: TMenuItem
      Action = atnCaptureBarCodes
    end
    object CheckallReceived1: TMenuItem
      Action = atnUpdateAllReceivedBatches
    end
    object N3: TMenuItem
      Caption = '-'
    end
    object GRVTextFile1: TMenuItem
      Action = atnCreatePMPUTextFile
    end
  end
  object mnuType: TPopupMenu
    Left = 528
    Top = 88
    object Depot1: TMenuItem
      Tag = 1
      Caption = 'Depot'
      OnClick = Depot1Click
    end
    object DDV1: TMenuItem
      Tag = 2
      Caption = 'DDV'
      OnClick = Depot1Click
    end
    object BuyOut1: TMenuItem
      Tag = 3
      Caption = 'Buy Out'
      OnClick = Depot1Click
    end
  end
  object mnuVAT: TPopupMenu
    Left = 584
    Top = 96
    object IncludeVatonItems1: TMenuItem
      Tag = 1
      Caption = 'Add VAT to Extended Cost'
      OnClick = IncludeVatonItems1Click
    end
    object VATalreadyonitems1: TMenuItem
      Tag = 2
      Caption = 'VAT Included on Pack Cost'
      OnClick = IncludeVatonItems1Click
    end
  end
  object dxEditStyle_NoBorder: TdxEditStyleController
    BorderColor = clDefault
    BorderStyle = xbsNone
    ButtonStyle = btsFlat
    Left = 256
  end
  object dxEditStyle_Flat: TdxEditStyleController
    BorderColor = clDefault
    BorderStyle = xbsFlat
    ButtonStyle = btsFlat
    HotTrack = True
  ...
  object PopupMenu2: TPopupMenu
    Left = 272
    Top = 120
    object PrintselectedReceivingReport1: TMenuItem
      Action = atnPrintReceipt
      Caption = 'Print selected &Receiving Report '
    end
    object PrintselectedreceivingreportOutstandingItems1: TMenuItem
      Action = atnPrintReceiptOutstanding
    end
  end
end
