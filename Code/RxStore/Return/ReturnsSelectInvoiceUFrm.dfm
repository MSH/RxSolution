object ReturnsSelectInvoiceFrm: TReturnsSelectInvoiceFrm
  Left = 379
  Top = 144
  Width = 1135
  Height = 718
  BorderIcons = [biSystemMenu]
  Caption = 'Invoice Number Selector'
  Color = clBtnFace
  ...
  object pnlRequisitionListBackground: TPanel
    ...
    object lblMainFormTitle: TLMDSimpleLabel
      ...
      ParentFont = False
      Transparent = False
      Caption = 'I n v o i c e  N u m b e r  S e l e c t o r'
      Options = []
    end
    ...
    object dbgReceipts: TdxDBGrid
      ...
      ParentFont = False
      TabOrder = 3
      OnDblClick = dbgReceiptsDblClick
      BandFont.Charset = ANSI_CHARSET
      BandFont.Color = clWindowText
      BandFont.Height = -11
      BandFont.Name = 'MS Sans Serif'
      BandFont.Style = []
      DataSource = ReturnsDm.dsReceipts
      Filter.Active = True
      ...
      HeaderFont.Style = []
      LookAndFeel = lfFlat
      OptionsBehavior = [edgoAnsiSort, edgoAutoSearch, edgoAutoSort, edgoDragScroll, edgoSeekDetail, edgoShowHourGlass, edgoStoreToRegistry, edgoTabThrough, edgoVertThrough]
      ...
      object dbgReceiptsReceived_dat: TdxDBGridColumn
    ...
    object dteEndDate: TDateTimePicker
      Left = 558
      Top = 22
      Width = 123
      Height = 21
      ...
      ParseInput = False
      TabOrder = 5
      OnChange = dteEndDateChange
    end
  end
  object atnInvoiceActions: TActionList
    Left = 288
    Top = 136
    object atnInvoicePageUp: TAction
      Category = 'Dataset'
      Caption = 'atnInvoicePageUp'
      OnExecute = atnInvoicePageUpExecute
      OnUpdate = atnInvoicePageUpUpdate
    end
    object atnInvoicePageDown: TAction
      Category = 'Dataset'
      Caption = 'atnInvoicePageDown'
      OnExecute = atnInvoicePageDownExecute
      OnUpdate = atnInvoicePageDownUpdate
    end
    object atnInvoiceFirst: TDataSetFirst
      Category = 'Dataset'
      Caption = '&First'
      Hint = 'First'
      ImageIndex = 0
    ...
    object atnInvoicePrior: TDataSetPrior
      Category = 'Dataset'
      Caption = '&Prior'
      Hint = 'Prior'
      ImageIndex = 1
    ...
    object atnInvoiceNext: TDataSetNext
      Category = 'Dataset'
      Caption = '&Next'
      Hint = 'Next'
      ImageIndex = 2
    ...
    object atnInvoiceLast: TDataSetLast
      Category = 'Dataset'
      Caption = '&Last'
      Hint = 'Last'
      ImageIndex = 3
