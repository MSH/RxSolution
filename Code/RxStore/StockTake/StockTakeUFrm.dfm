object StockTakeFrm: TStockTakeFrm
  Left = 246
  Top = 161
  Width = 1442
  Height = 782
  ...
  object Panel7: TPanel
    ...
    object pnlToolBar: TPanel
      ...
      object ElSpeedButton3: TElSpeedButton
        ...
        Color = clBtnFace
        ParentColor = False
        Action = StockTakeDM.atnRefreshStocktakeList
        DockOrientation = doNoOrient
      end
      ...
      object Panel6: TPanel
        ...
        object dteEnd: TDateTimePicker
          ...
          Height = 24
          CalAlignment = dtaLeft
          Date = 37623.9969560185
          Time = 37623.9969560185
          DateFormat = dfShort
          DateMode = dmComboBox
          Kind = dtkDate
          ParseInput = False
    ...
    object dbgStockTake: TdxDBGrid
      ...
      TabOrder = 2
      OnDblClick = atnEditCurrentRecordExecute
      ArrowsColor = clNavy
      ...
      BandFont.Style = []
      DataSource = StockTakeDM.dsStockTakeCatalog
      Filter.Active = True
      ...
      IndentDesc = 10
      LookAndFeel = lfFlat
      OptionsBehavior = [edgoAutoSearch, edgoAutoSort, edgoCaseInsensitive, edgoDragScroll, edgoEnterShowEditor, edgoImmediateEditor, edgoMultiSort, edgoStoreToRegistry, edgoTabThrough, edgoVertThrough]
      ...
      PreviewFont.Style = []
      RegistryPath = '\Software\RxSolution\1.2\Grids\StockTake\dbgStockTake\Columns'
      RowFooterColor = clHighlight
      RowFooterTextColor = clWindow
      object dbgStockTakeStockTake_dat: TdxDBGridDateColumn
        Caption = 'Date'
        DisableEditor = True
        Width = 66
        BandIndex = 0
      ...
      object dbgStockTakeStockTake_str: TdxDBGridMaskColumn
        Caption = 'Ref. number'
        DisableEditor = True
        Width = 145
        BandIndex = 0
      ...
      object dbgStockTakeItemsNo_int: TdxDBGridMaskColumn
        Caption = 'Items'
        DisableEditor = True
        Width = 68
        BandIndex = 0
      ...
      object dbgStockTakeCompleted_bol: TdxDBGridCheckColumn
        Caption = 'Posted'
        DisableEditor = True
        MinWidth = 20
        Width = 107
      ...
      object dbgStockTakeActivated_dat: TdxDBGridColumn
        Caption = 'Posted Date'
        DisableEditor = True
        BandIndex = 0
        RowIndex = 0
      ...
      object dbgStockTakeTotalCost_mon: TdxDBGridCurrencyColumn
        Caption = 'Total Cost'
        Width = 135
        BandIndex = 0
        RowIndex = 0
      ...
      object dbgStockTakeVerifiedBy_str: TdxDBGridColumn
        Caption = 'Verified By'
        DisableEditor = True
        Width = 130
        BandIndex = 0
      ...
      object dbgStockTakeStockCapturedBy_str: TdxDBGridColumn
        Caption = 'Captured By'
        DisableEditor = True
        Width = 226
        BandIndex = 0
      ...
      object dbgStockTakeReason_str: TdxDBGridColumn
        Caption = 'Reason'
        DisableEditor = True
        Width = 113
        BandIndex = 0
  ...
  object ActionList1: TActionList
    Left = 720
    Top = 16
    object atnEditCurrentRecord: TAction
      Caption = 'Edit (Stocktake)'
      Hint = 'View / Edit Stocktake'
      ShortCut = 16453
      OnExecute = atnEditCurrentRecordExecute
    end
    object atnAddNewStockTake: TAction
      Caption = 'Add (Stocktake)'
      Hint = 'Add Stocktake'
      ShortCut = 16449
      OnExecute = atnAddNewStockTakeExecute
    end
    object atnFirst: TDataSetFirst
      Category = 'Dataset'
      Caption = '&First'
      Hint = 'First'
      ImageIndex = 0
    end
    object atnLast: TDataSetLast
      Category = 'Dataset'
      Caption = '&Last'
      Hint = 'Last'
      ImageIndex = 3
    end
    object atnNext: TDataSetNext
      Category = 'Dataset'
      Caption = '&Next'
      Hint = 'Next'
      ImageIndex = 2
    end
    object atnPrior: TDataSetPrior
      Category = 'Dataset'
      Caption = '&Prior'
      Hint = 'Prior'
      ImageIndex = 1
    end
    object atnViewStockTake: TAction
      Caption = 'atnViewStockTake'
      OnExecute = atnViewStockTakeExecute
    end
    object atnColumnSelector: TAction
      Caption = 'atnColumnSelector'
      OnExecute = atnColumnSelectorExecute
    end
    object atnUnLockStocktake: TAction
      Caption = 'UnLock Stocktake'
      OnExecute = atnUnLockStocktakeExecute
    end
  end
  object PopupMenu1: TPopupMenu
    ...
    object PrintStocktakeCtrlP1: TMenuItem
      Action = StockTakeDM.atnPrintStockTake
    end
    object PrintSurplusReportCtrlAltS1: TMenuItem
      Action = StockTakeDM.atnPrint_Surpluses
    end
    object PrintDeficitReportCtrlAltS1: TMenuItem
      Action = StockTakeDM.atnPrint_Deficits
    end
    object N2: TMenuItem
      Caption = '-'
    end
    object UnLockStocktake1: TMenuItem
      Action = atnUnLockStocktake
    end
  end
  object PopPrintMenu: TPopupMenu
    ...
    object PrintSecondCountReport1: TMenuItem
