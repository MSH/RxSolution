...
begin
 ...
 if vType = 1 then
  MSG := 'The product description has been updated. This will affect one or more standard regimen.'
 else
  MSG := 'The product has been removed from the Institutional EDL. This will affect one or more standard regimen.';
