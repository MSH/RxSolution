object CreditsDetailFrm: TCreditsDetailFrm
  Left = 300
  Top = 149
  Width = 1490
  Height = 842
  ...
  object Panel4: TPanel
    ...
    object btnClose: TButton
      ...
      Width = 92
      Height = 31
      Action = CreditsDm.atnSaveandClose
  ...
  object PageTakeItems: TRzPageControl
    ...
    object tbsCreditItems: TRzTabSheet
      Color = clWhite
      Caption = 'Details'
      object dbgCreditItems: TdxDBGrid
        Left = 0
        Top = 0
        Width = 1472
        Height = 464
        ...
        BandFont.Style = []
        DataSource = CreditsDm.dsCreditItems
        ...
        PreviewFont.Style = []
        RegistryPath = '\Software\RxSolution\1.2\Grids\Credit\ddbCreditItems'
        RowFooterColor = clHighlight
        RowFooterTextColor = clWindow
        Anchors = [akLeft, akTop, akRight]
        object dbgCreditItemICN_str: TdxDBGridColumn
          Caption = 'ICN'
          DisableEditor = True
          Width = 91
          BandIndex = 0
        ...
        object dbgCreditItemECN_str: TdxDBGridColumn
          Caption = 'ECN'
          DisableEditor = True
          Width = 48
          BandIndex = 0
        ...
        object dbgCreditItemNSN_str: TdxDBGridColumn
          Caption = 'NSN'
          DisableEditor = True
          Width = 43
          BandIndex = 0
        ...
        object dbgCreditItemsDescription_str: TdxDBGridColumn
          Caption = 'Description'
          DisableEditor = True
          Width = 123
          BandIndex = 0
        ...
        object dbgQtyCredited_int: TdxDBGridMaskColumn
          Caption = 'Qty'
          Width = 151
          BandIndex = 0
          RowIndex = 0
        ...
        object dbgSellingPrice_mon: TdxDBGridCurrencyColumn
        ...
        object dbgCreditItemBin_str: TdxDBGridPickColumn
          Caption = 'Bin'
          Width = 77
          BandIndex = 0
          RowIndex = 0
        ...
        object dbgCreditItemsShippingPack_int: TdxDBGridColumn
    ...
    object tbsCredit_Remarks: TRzTabSheet
      ...
      object RzDBNotesField: TRzDBMemo
        ...
        DataSource = CreditsDm.dsCreditsCatalog
        TabOrder = 0
    ...
    object tbsCreditHistory: TRzTabSheet
      ...
      object dxDBCreditHistory: TdxDBGrid
        Left = 0
        Top = 0
        Width = 1470
        Height = 477
        ...
        BandFont.Name = 'MS Sans Serif'
        BandFont.Style = []
        DataSource = CreditsDm.dsHistory
        Filter.Active = True
        Filter.DropDownCount = 16
        Filter.Criteria = {00000000}
        GridLineColor = clInactiveCaptionText
        ...
        PreviewFont.Name = 'MS Sans Serif'
        PreviewFont.Style = []
        RegistryPath = '\Software\RxSolution\1.2\Grids\Credit\History'
        RowFooterColor = clHighlight
        RowFooterTextColor = clWindow
        object dxDBCreditHistoryDate_dat: TdxDBGridColumn
          Caption = 'Date'
          DisableEditor = True
          BandIndex = 0
          RowIndex = 0
        ...
        object dxDBCreditHistoryDescription_str: TdxDBGridColumn
          Caption = 'Description'
          DisableEditor = True
          BandIndex = 0
          RowIndex = 0
        ...
        object dxDBCreditHistoryUserName_str: TdxDBGridColumn
          Caption = 'User name'
          DisableEditor = True
          BandIndex = 0
          RowIndex = 0
        ...
        object dxDBCreditHistoryType_str: TdxDBGridColumn
          Caption = 'Type'
          DisableEditor = True
          BandIndex = 0
          RowIndex = 0
  ...
  object Panel1: TPanel
    ...
    object pnlHeaderBackground: TPanel
      ...
      object lblDate: TDBText
        ...
        DataSource = CreditsDm.dsqryCreditWorker
        Font.Charset = ANSI_CHARSET
        Font.Color = clHighlight
        Font.Height = -15
        Font.Name = 'Tahoma'
      ...
      object btnPostClose: TButton
        ...
        Width = 208
        Height = 50
        Action = CreditsDm.atnPostandClose
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Height = -15
        Font.Name = 'MS Sans Serif'
      ...
      object cmbDemanderCode: TRzDBLookupComboBox
        ...
        ListField = 'Code_str'
        ListSource = CreditsDm.dsDemanders
        ParentCtl3D = False
        TabOrder = 0
        FrameSides = []
        FrameVisible = True
      ...
      object cmbReceivedBy: TRzDBLookupComboBox
        Left = 306
        Top = 81
        Width = 1039
        Height = 24
      ...
      object RzDBLookupComboBox1: TRzDBLookupComboBox
        ...
        Constraints.MaxHeight = 21
        Ctl3D = False
        DataField = 'ReturnedBy_id'
        DataSource = CreditsDm.dsqryCreditWorker
        DropDownRows = 10
        KeyField = 'DemanderUser_ID'
        ListField = 'personDescription_str'
        ListSource = CreditsDm.dsDemanderUsers
        ParentCtl3D = False
        TabOrder = 4
        FlatButtons = False
        DisabledColor = clWhite
      ...
      object RzDBLookupComboBox2: TRzDBLookupComboBox
        ...
        ListSource = CreditsDm.dsqryADOSystemWharehouse
        ParentCtl3D = False
        TabOrder = 2
        FrameSides = []
        FrameVisible = True
    ...
    object Panel2: TPanel
      ...
      Color = clWhite
      TabOrder = 1
      object lblCreditNo_str: TDBText
        Left = 1109
        Top = 1
        Width = 133
        Height = 43
  ...
  object Panel3: TPanel
    ...
    object ElSpeedButton5: TElSpeedButton
      ...
      Color = clBtnFace
      ParentColor = False
      Action = CreditsDm.atnDeleteSingleItem
      DockOrientation = doNoOrient
    end
    object ElSpeedButton6: TElSpeedButton
      ...
      Color = clBtnFace
      ParentColor = False
      Action = CreditsDm.atnAddSingleItem
      DockOrientation = doNoOrient
    end
    ...
    object ElSpeedButton16: TElSpeedButton
      ...
      Color = clBtnFace
      ParentColor = False
      Action = CreditsDm.atnCancelItem
      DockOrientation = doNoOrient
    end
    object Button1: TButton
      ...
      Width = 92
      Height = 31
      Action = CreditsDm.atnSelectBatch
      TabOrder = 0
    end
  end
  object PopupMenu1: TPopupMenu
    ...
    object AddAnotherBatchItem1: TMenuItem
      Action = CreditsDm.atnAddAnotherBatchItem
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object RemoveAllItems1: TMenuItem
      Action = CreditsDm.atnDeleteAllItems
    end
    object AddRequisitionItems1: TMenuItem
      Action = CreditsDm.atnAddRequisitionItems
    end
    object N2: TMenuItem
      Caption = '-'
    end
  ...
  object PopMenuPrint: TPopupMenu
    Left = 872
    Top = 120
    object PrintReturnOut2: TMenuItem
      Action = CreditsDm.atnPrintCreditNoteReport
    end
  end
end
