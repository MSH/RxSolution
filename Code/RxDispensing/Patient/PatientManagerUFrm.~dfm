object PatientManagerFrm: TPatientManagerFrm
  Left = 218
  Top = 95
  Width = 1297
  Height = 762
  ...
  object pnl_Main_Back: TPanel
    ...
    object pnl_Main_PatientListPanel: TPanel
      ...
      object grdPatients: TdxDBGrid
        ...
        TabOrder = 1
        OnDblClick = atnPatient_EditExecute
        BandFont.Charset = ANSI_CHARSET
        BandFont.Color = clWindowText
        BandFont.Height = -11
        BandFont.Name = 'MS Sans Serif'
        BandFont.Style = []
        DataSource = dsqryPatients
        Filter.Active = True
        ...
        PreviewFont.Style = []
        RegistryPath = '\Software\RxSolution\1.2\Grids\Patient\grdPatients'
        object grdPatientspersonRefNoCurrent_str: TdxDBGridColumn
          Caption = 'IPN'
          DisableEditor = True
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
        ...
        object grdPatientspersonPAS_str: TdxDBGridColumn
          Caption = 'PAS #'
          DisableEditor = True
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
        ...
        object grdPatientspersonLastName_Str: TdxDBGridColumn
          Caption = 'Last Name'
          DisableEditor = True
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
        ...
        object grdPatientspersonFirstName_Str: TdxDBGridColumn
          Caption = 'First Name'
          DisableEditor = True
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
        ...
        object grdPatientspersonGender_Str: TdxDBGridColumn
          Caption = 'Gender'
          DisableEditor = True
          Width = 56
          BandIndex = 0
        ...
        object grdPatientspersonInstitution_str: TdxDBGridColumn
          Caption = 'Clinic'
          DisableEditor = True
          Width = 41
          BandIndex = 0
        ...
        object grdPatientsAgeInYears_int: TdxDBGridColumn
          Caption = 'Age'
          DisableEditor = True
          Width = 45
          BandIndex = 0
        ...
        object grdPatientsActive_bol: TdxDBGridCheckColumn
          Caption = 'Active'
          DisableEditor = True
          MinWidth = 20
          Visible = False
        ...
        object grdPatientspersonTransferredInDate_dat: TdxDBGridColumn
          Caption = 'Trans In Date'
          Visible = False
          BandIndex = 0
          RowIndex = 0
          FieldName = 'personTransferredInDate_dat'
        end
        object grdPatientspersonTransferredInFrom_str: TdxDBGridColumn
          Caption = 'From'
          Visible = False
          BandIndex = 0
          RowIndex = 0
        ...
        object grdPatientspersonIDNumber_Str: TdxDBGridColumn
          Caption = 'ID/Passport'
          DisableEditor = True
          BandIndex = 0
          RowIndex = 0
        ...
        object grdPatientsClassification_str: TdxDBGridColumn
          Caption = 'Class'
          DisableEditor = True
          Visible = False
          BandIndex = 0
        ...
        object grdPatientspersonDOB_Dat: TdxDBGridColumn
          Caption = 'DOB'
          DisableEditor = True
          BandIndex = 0
          RowIndex = 0
    ...
    object pnl_Main_QuestionnairePanel: TPanel
      ...
      object grdRxListPerPatient: TdxDBGrid
        Left = 5
        Top = 59
        Width = 1065
        Height = 730
        ...
        PreviewFont.Name = 'MS Sans Serif'
        PreviewFont.Style = []
        RegistryPath = '\Software\RxSolution\1.2\Grids\Patient\grdRxListPerPatient'
        object grdRxListPerPatientdate_Dat: TdxDBGridDateColumn
          Caption = 'Date'
          DisableEditor = True
          Sorted = csUp
          Width = 105
        ...
        object grdRxListPerPatientrepeats_Int: TdxDBGridMaskColumn
          Caption = 'Repeats'
          DisableEditor = True
          Width = 76
          BandIndex = 0
        ...
        object grdRxListPerPatientrepeatNo_Int: TdxDBGridMaskColumn
          Caption = '#'
          DisableEditor = True
          Width = 45
          BandIndex = 0
        ...
        object grdRxListPerPatientdispensingPosted_bol: TdxDBGridCheckColumn
          Caption = 'Posted'
          DisableEditor = True
          Width = 52
          BandIndex = 0
        ...
        object grdRxListPerPatientdownRefferal_Str: TdxDBGridColumn
          Caption = 'Batch'
          DisableEditor = True
          Width = 47
          BandIndex = 0
        ...
        object grdRxListPerPatientprescriptionNumber_Str: TdxDBGridColumn
          Caption = 'Rx No'
          DisableEditor = True
          Width = 47
          BandIndex = 0
        ...
        object grdRxListPerPatientfolderNumber_Str: TdxDBGridColumn
          Caption = 'Folder'
          DisableEditor = True
          Width = 51
          BandIndex = 0
        ...
        object grdRxListPerPatientprescriberName_Str: TdxDBGridColumn
          Caption = 'Prescriber'
          DisableEditor = True
          Width = 79
          BandIndex = 0
        ...
        object grdRxListPerPatientdispenserName_Str: TdxDBGridColumn
          Caption = 'Dispenser'
          DisableEditor = True
          Width = 77
          BandIndex = 0
        ...
        object grdRxListPerPatientprescriptionCost_Mon: TdxDBGridCurrencyColumn
          Caption = 'Cost'
          DisableEditor = True
          Width = 38
          BandIndex = 0
        ...
        object grdRxListPerPatientprescriptionItemsCount_Int: TdxDBGridMaskColumn
          Caption = 'Items'
          DisableEditor = True
          Width = 50
          BandIndex = 0
        ...
        object grdRxListPerPatientnaive_bol: TdxDBGridCheckColumn
          Caption = 'Naive'
          DisableEditor = True
          Width = 92
          BandIndex = 0
        ...
        object grdRxListPerPatientVisitDate_dat: TdxDBGridColumn
          Caption = 'Visit Date'
          DisableEditor = True
          Visible = False
          Width = 106
  ...
  object conPatient: TADOConnection
    ...
    ConnectionString = 
      ...
      'ue;User ID=sa;Initial Catalog=rx1.7;Data Source=.\SQLEXPRESS'
  ...
  object qryPatients: TADOQuery
    Connection = conPatient
    CursorType = ctStatic
    AfterScroll = qryPatientsAfterScroll
    Parameters = <>
    SQL.Strings = (
      'SELECT  *'
  ...
  object pmnuPatient: TPopupMenu
    ...
    object BioDataSheet1: TMenuItem
      Action = atnPrintPatientBIODataSheet
    end
  end
  object pmnuPrint: TPopupMenu
    Left = 480
    Top = 16
    object BioDataSheet2: TMenuItem
      Action = atnPrintPatientBIODataSheet
    end
  end
  object dsqryPatients: TDataSource
    DataSet = qryPatients
    Left = 512
    Top = 192
  end
  object ActionList1: TActionList
    Left = 200
    Top = 24
    object atnPatient_Add: TAction
      Category = 'CRUD'
      Caption = 'Add...'
      OnExecute = atnPatient_AddExecute
    end
    object atnPatient_Edit: TAction
      Category = 'CRUD'
      Caption = 'Edit...'
      OnExecute = atnPatient_EditExecute
    end
    object atnPrntPrescribersByName: TAction
      Category = 'Print'
      Caption = 'Print Patient List [Sorted By Name]'
      OnExecute = atnPrntPrescribersByNameExecute
    end
    object atnPrntPrescribersByNumber: TAction
      Category = 'Print'
      Caption = 'Print Patient List [Sorted By Number]'
      OnExecute = atnPrntPrescribersByNumberExecute
    end
    object atnPrintPatientBIODataSheet: TAction
      Category = 'Print'
      Caption = 'Bio Data Sheet'
      OnExecute = atnPrintPatientBIODataSheetExecute
    end
    object atnPrntPrescribersByClinic: TAction
      Category = 'Print'
      Caption = 'Print Patient List [Sorted By Clinic]'
      OnExecute = atnPrntPrescribersByClinicExecute
    end
    object atnPatient_Delete: TAction
      Category = 'CRUD'
      Caption = 'Delete...'
      OnExecute = atnPatient_DeleteExecute
    end
    object atnPatientDisplayColumns: TAction
      Caption = 'Patient Columns'
      OnExecute = atnPatientDisplayColumnsExecute
    end
    object atnPatientRxDisplayColumns: TAction
      Caption = 'Rx Columns'
      OnExecute = atnPatientRxDisplayColumnsExecute
    end
    ...
    object atnCopyRx: TAction
      Category = 'CRUD'
      Caption = 'Copy Prescription'
      OnExecute = atnCopyRxExecute
    end
    object atnFindPatients: TAction
      Caption = 'Search'
      OnExecute = atnFindPatientsExecute
    end
  end
  object qryRxList: TADOQuery
    Connection = conPatient
    CursorType = ctStatic
    DataSource = dsqryPatients
    Parameters = <
      item
        ...
        Precision = 255
        Size = 38
        Value = '{934EE026-5C80-4831-BB0A-3A9526019BCA}'
      end
      item
        Name = '@StartDate'
        Attributes = [paNullable]
  ...
  object dsqryRxList: TDataSource
    DataSet = qryRxList
    Left = 512
    Top = 224
  end
  ...
  object ppDBPipeline1: TppDBPipeline
    DataSource = dsqryRxList
    CloseDataSource = True
    UserName = 'DBBioDataSheet1'
    Left = 648
    Top = 384
    MasterDataPipelineName = 'ppDBBioDataSheet'
  end
  ...
  object qryFindLastAddedPatient: TADOQuery
    Connection = conPatient
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
  ...
  object PopupMenu1: TPopupMenu
    Left = 416
    Top = 16
    object atnPrescriptionEdit1: TMenuItem
      Action = atnPrescription_Edit
    end
    object CopyPrescription1: TMenuItem
      Action = atnCopyRx
    end
  end
  object Stp_AddPatient: TADOStoredProc
    Connection = conPatient
    ProcedureName = 'AddPatient;1'
    Parameters = <
      item
        Name = '@PatientNumber'
        Attributes = [paNullable]
      ...
      item
        Name = '@personNextOfHomePhone_str'
        Attributes = [paNullable]
        DataType = ftFixedChar
        Size = 13
        Value = Null
      ...
      item
        Name = '@personNextOfKinFirstName_str'
        Attributes = [paNullable]
        DataType = ftFixedChar
        Size = 20
        Value = Null
      ...
      item
        Name = '@personNextOfKinSurname_str'
        Attributes = [paNullable]
        DataType = ftFixedChar
        Size = 20
        Value = Null
      ...
      item
        Name = '@personNextOfPostalCode_str'
        Attributes = [paNullable]
        DataType = ftFixedChar
        Size = 10
        Value = Null
      ...
      item
        Name = '@personNextOfWorkPhone_str'
        Attributes = [paNullable]
        DataType = ftFixedChar
        Size = 13
        Value = Null
  ...
  object qryPatientHopping: TADOQuery
    ...
    SQL.Strings = (
      'SELECT ConsultingRoom_str, Date_dat'
