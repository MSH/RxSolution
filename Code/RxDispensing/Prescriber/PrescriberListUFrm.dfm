object PrescriberListFrm: TPrescriberListFrm
  Left = 319
  Top = 275
  Width = 1024
  Height = 640
  Caption = 'PrescriberListFrm'
  Color = clBtnFace
    ...
    object pnl_Main_PatientListPanel: TPanel
      ...
      object Panel2: TPanel
        ...
        object ElSpeedButton19: TElSpeedButton
          ...
          Color = clBtnFace
          ParentColor = False
          Action = atnPrescriber_GridColumns
      ...
      object grdPrescribers: TdxDBGrid
        ...
        PreviewFont.Style = []
        RegistryPath = '\Software\RxSolution\1.2\Grids\Prescriber\grdPrescribers'
        ...
        object grdPrescriberspersonRefNoCurrent_str: TdxDBGridColumn
  ...
  object conPrescriber: TADOConnection
    ...
    ConnectionString = 
      ...
      'ue;User ID=sa;Initial Catalog=Rx1.5;Data Source=.'
    LoginPrompt = False
    Provider = 'SQLOLEDB.1'
    Left = 136
    Top = 56
  ...
  object qryPrescriber: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM view_v01_Prescriber_List')
    Left = 176
    Top = 64
  end
  object pmuPrescriber: TPopupMenu
    Left = 176
    Top = 96
  ...
  object ActionList1: TActionList
    ...
    object atnPrescriber_GridColumns: TAction
      Caption = 'atnPrescriber_GridColumns'
      OnExecute = atnPrescriber_GridColumnsExecute
    end
  end
  object qryPrintRegisterByName: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT  dbo.view_v01_Prescriber_List.* , tblContact.contactDetai' +
        'l_Str,  dbo.tblPersonPosition.personPositionNumberNo_Str, dbo.tb' +
        'lRxLevel.rxLevelCode_Str'
      ''
      
        'FROM        dbo.tblContact, dbo.view_v01_Prescriber_List, dbo.tb' +
        'lRxLevel, dbo.tblPersonPosition '
      ' '
      
        'Where dbo.tblPersonPosition.person_ID =  dbo.view_v01_Prescriber' +
        '_List.person_ID '
      
        'And  dbo.tblRxLevel.rxLevel_ID = dbo.tblPersonPosition.rxLevel_I' +
        'D'
      
        'AND dbo.tblContact.linking_ID = dbo.view_v01_Prescriber_List.per' +
        'son_ID '
      ''
      'Order By view_v01_Prescriber_List.personLastName_str')
    Left = 320
    Top = 24
  end
  ...
  object qryPrintRegisterByNumber: TADOQuery
    ...
    SQL.Strings = (
      ...
      ' '
        ...
        'and dbo.tblContact.linking_ID = dbo.view_v01_Prescriber_List.per' +
        'son_ID '
      'order by dbo.tblPersonPosition.personPositionNumberNo_Str')
    Left = 320
    Top = 56
  end
  ...
  object qryPrintRegisterConsultants: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'AND dbo.tblContact.linking_ID = dbo.view_v01_Prescriber_List.per' +
        'son_ID '
      'AND (tblPersonPosition.personPositionNumberNo_Str LIKE '#39'C%'#39')'
      'ORDER BY dbo.tblPersonPosition.personPositionNumberNo_Str')
    Left = 320
    Top = 88
  end
  ...
  object qryNoficationLetter: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT tblSystem.provincialLogo_img, tblPerson.personIDNumber_St' +
        'r, tblPerson.personLastName_Str, tblPerson.personFirstName_Str, ' +
        ' tblPerson.personInitials_Str, tblPersonPosition.personPositionC' +
        'urrent_bol, tblPersonPosition.personPositionNumberNo_Str,  tblPe' +
        'rsonPosition.personPositionTitle_Str, tblPersonPosition.personPo' +
        'sitionStart_Dat, tblPersonPosition.personPositionEnd_Dat,  tblPe' +
        'rsonType.personTypeDescription_Str, tblPerson.person_ID, tblPers' +
        'onPositionTitle.personPositionTitleDescription_Str,  tblPersonPo' +
        'sition.personPositionDescription_Str, tblRxLevel.rxLevelCode_Str' +
        ', tblPerson.personRegistrationNo_str,  tblComplex.complexName_st' +
        'r'
      
        'FROM tblSystem, tblComplex INNER JOIN tblComplexSiteDepartment I' +
        'NNER JOIN tblComplexSite ON tblComplexSiteDepartment.complexSite' +
        '_ID = tblComplexSite.complexSite_ID ON  tblComplex.complex_ID = ' +
        'tblComplexSite.complex_ID RIGHT OUTER JOIN tblRxLevel INNER JOIN' +
        ' tblPersonPosition ON tblRxLevel.rxLevel_ID = tblPersonPosition.' +
        'rxLevel_ID ON  tblComplexSiteDepartment.complexSiteDepartment_ID' +
        ' = tblPersonPosition.complexSiteDepartment_ID LEFT OUTER JOIN tb' +
        'lPersonPositionTitle ON tblPersonPosition.personPositionTitle_ID' +
        ' = tblPersonPositionTitle.personPositionTitle_ID RIGHT OUTER JOI' +
        'N tblPerson ON tblPersonPosition.person_ID = tblPerson.person_ID' +
        ' LEFT OUTER JOIN tblPersonType ON tblPersonPosition.personType_I' +
        'D = tblPersonType.personType_ID'
    ...
    Left = 320
    Top = 184
    object qryNoficationLetterprovincialLogo_img: TBlobField
      FieldName = 'provincialLogo_img'
    end
    object qryNoficationLetterpersonIDNumber_Str: TWideStringField
      FieldName = 'personIDNumber_Str'
    end
    object qryNoficationLetterpersonLastName_Str: TWideStringField
      FieldName = 'personLastName_Str'
      Size = 30
    end
    object qryNoficationLetterpersonFirstName_Str: TWideStringField
      FieldName = 'personFirstName_Str'
      Size = 30
    end
    object qryNoficationLetterpersonInitials_Str: TWideStringField
      FieldName = 'personInitials_Str'
      Size = 10
    end
    object qryNoficationLetterpersonPositionCurrent_bol: TBooleanField
      FieldName = 'personPositionCurrent_bol'
    end
    object qryNoficationLetterpersonPositionNumberNo_Str: TWideStringField
      FieldName = 'personPositionNumberNo_Str'
      Size = 50
    end
    object qryNoficationLetterpersonPositionTitle_Str: TWideStringField
      FieldName = 'personPositionTitle_Str'
      Size = 15
    end
    object qryNoficationLetterpersonPositionStart_Dat: TDateTimeField
      FieldName = 'personPositionStart_Dat'
    end
    object qryNoficationLetterpersonPositionEnd_Dat: TDateTimeField
      FieldName = 'personPositionEnd_Dat'
    end
    object qryNoficationLetterpersonTypeDescription_Str: TWideStringField
      FieldName = 'personTypeDescription_Str'
      Size = 100
    end
    object qryNoficationLetterperson_ID: TGuidField
      FieldName = 'person_ID'
      FixedChar = True
      Size = 38
    end
    object qryNoficationLetterpersonPositionTitleDescription_Str: TWideStringField
      FieldName = 'personPositionTitleDescription_Str'
      Size = 50
    end
    object qryNoficationLetterpersonPositionDescription_Str: TWideStringField
      FieldName = 'personPositionDescription_Str'
      Size = 200
    end
    object qryNoficationLetterrxLevelCode_Str: TWideStringField
      FieldName = 'rxLevelCode_Str'
      Size = 3
    end
    object qryNoficationLetterpersonRegistrationNo_str: TWideStringField
      FieldName = 'personRegistrationNo_str'
    end
    object qryNoficationLettercomplexName_str: TWideStringField
  ...
  object ppReportRegisterConsultants: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel12: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'Prescriber Register [ by Consultans]'
        Font.Charset = ANSI_CHARSET
        Font.Color = clGray
        Font.Name = 'Arial Narrow'
        Font.Size = 24
  ...
  object qryFindLastAddedPrescriber: TADOQuery
    Connection = conPrescriber
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
