object AdherencePatientRecordFrm: TAdherencePatientRecordFrm
  Left = 308
  Top = 51
  Width = 1257
  Height = 862
  Caption = 'Patient Adherence Record'
  Color = clBtnFace
  ...
  object pnlMain: TPanel
    ...
    object pnlForm_Footer: TRzGroupBox
      ...
      object Label3: TLabel
        ...
        Width = 203
        Height = 22
        Caption = 'Adherence Improvement Plan'
        Font.Charset = ANSI_CHARSET
        Font.Color = clGray
        Font.Height = -17
        Font.Name = 'Arial Narrow'
      ...
      object RzDBRichEdit1: TRzDBRichEdit
        ...
        DataSource = dmPatient.dsAdherenceWorker
        TabOrder = 0
      end
    ...
    object pnlForm_Header: TPanel
      ...
      object lblPostedDate: TRzDBLabel
        Left = 1031
        Top = 1
        Width = 140
        Height = 80
      ...
      object RzDBDateTimePicker1: TRzDBDateTimePicker
        ...
        Date = 0.887409930597642
        Time = 0.887409930597642
        DateFormat = dfShort
        DateMode = dmComboBox
        Font.Charset = ANSI_CHARSET
        Font.Color = clGray
      ...
      object pnlDescripHeader: TRzGroupBox
        ...
        object RzDBDateTimePicker2: TRzDBDateTimePicker
          ...
          Height = 30
          CalAlignment = dtaLeft
          Date = 40644.6705152199
          Time = 40644.6705152199
          DateFormat = dfShort
          DateMode = dmComboBox
          Font.Charset = ANSI_CHARSET
          Font.Color = clGray
    ...
    object pnlForm_Detail: TRzGroupBox
      ...
      Align = alCustom
      BorderColor = clBlue
      Caption = 'Adherence Support Measures'
      Color = clWhite
      FlatColor = clWhite
      Font.Charset = ANSI_CHARSET
      Font.Color = clGray
      ...
      ParentFont = False
      TabOrder = 3
      object cxSupportMeasures: TcxGrid
        Left = 1
        Top = 73
        Width = 1170
        Height = 358
        ...
        RootLevelOptions.DetailFrameColor = 16776176
        object cxSupportMeasuresDBTableView1: TcxGridDBTableView
          DataController.DataSource = dmPatient.dsAdherenceMeasures
          DataController.DetailKeyFieldNames = 'Adherence_ID'
          ...
          object cxSupportMeasuresDBTableView1SupportMeasureCode_str: TcxGridDBColumn
            Caption = 'Code'
            PropertiesClassName = 'TcxTextEditProperties'
            Options.Editing = False
            Width = 77
            DataBinding.FieldName = 'SupportMeasureCode_str'
          end
          object cxSupportMeasuresDBTableView1SupportMeasureDescription_str: TcxGridDBColumn
            Caption = 'Description'
            PropertiesClassName = 'TcxTextEditProperties'
            Options.Editing = False
            Width = 304
            DataBinding.FieldName = 'SupportMeasureDescription_str'
          end
          object cxGrid1DBTableViewAdherenceSupport_bol: TcxGridDBColumn
            Width = 35
            DataBinding.FieldName = 'AdherenceSupport_bol'
            IsCaptionAssigned = True
          end
          object cxSupportMeasuresDBTableView1Notes_mem: TcxGridDBColumn
            Caption = 'Notes'
            Width = 534
            DataBinding.FieldName = 'Notes_mem'
          end
        end
        object cxSupportMeasuresLevel1: TcxGridLevel
          GridView = cxSupportMeasuresDBTableView1
          Options.DetailFrameColor = 16776176
        end
      end
  ...
  object ActionList1: TActionList
    ...
    object DataSetInsert1: TDataSetInsert
      ...
      Hint = 'Insert'
      ImageIndex = 4
      DataSource = dmPatient.dsAdherenceMeasures
    end
  ...
  object PopupMenu1: TPopupMenu
    Left = 272
    Top = 256
    object PostAdherence1: TMenuItem
      Action = dmPatient.atnPostAdherence
    end
  end
end
