object RepackBatchSelectFrm: TRepackBatchSelectFrm
  Left = 600
  Top = 236
  BorderIcons = []
  ...
  object Panel2: TPanel
    ...
    object dxDBGrid1: TdxDBGrid
      ...
      BandFont.Style = []
      DataSource = PrepackingDM.dstmpItems
      ...
      object dxDBGrid1QtyUsed_dbl: TdxDBGridColumn
        Caption = 'Qty Used'
        BandIndex = 0
        RowIndex = 0
        OnChange = dxDBGrid1QtyUsed_dblChange
      ...
      object dxDBGrid1SourcePortion_dbl: TdxDBGridColumn
        Caption = ' SKU/Pack'
        BandIndex = 0
        RowIndex = 0
  ...
  object stpRemveItems: TADOQuery
    Connection = PrepackingDM.adoPrepacking
    Parameters = <
      item
        Name = 'PrepackingID'
  ...
  object qryTotalIssued: TADOQuery
    ...
    SQL.Strings = (
      'SELECT SUM(tblPrepackingItem.QtyUsed_dbl) AS TotQtyIssued'
      'FROM tblPrepackingItem'
      'INNER JOIN '
      'tblProductBatch '
      
        'ON tblProductBatch.ProductBatch_ID = tblPrepackingItem.ProductBa' +
        'tch_ID'
