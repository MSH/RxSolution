object OrderRequisitionSelectFrm: TOrderRequisitionSelectFrm
  Left = 463
  Top = 162
  BorderIcons = [biSystemMenu]
  BorderStyle = bsToolWindow
  Caption = 'OrderRequisitionSelectFrm'
  ClientHeight = 678
  ClientWidth = 753
  Color = clBtnFace
  ...
  object pnlRequisitionListBackground: TPanel
    ...
    object lblMainFormTitle: TLMDSimpleLabel
      ...
      ParentFont = False
      Transparent = False
      Caption = 'R e q u i s i t i o n  S e l e c t o r'
      Options = []
    end
    ...
    object dbgReqLookup: TdxDBGrid
      ...
      BandFont.Style = []
      DataSource = OrderDM.dsstpOrderListRequisitionsAvailable
      Filter.Active = True
      ...
      IndentDesc = 10
      LookAndFeel = lfFlat
      OptionsBehavior = [edgoAutoSearch, edgoAutoSort, edgoDragScroll, edgoEditing, edgoEnterShowEditor, edgoImmediateEditor, edgoMultiSelect, edgoMultiSort, edgoStoreToRegistry, edgoTabThrough, edgoVertThrough]
      ...
      PreviewFont.Style = []
      RegistryPath = '\Software\RxSolution\1.2\Grids\Orders\RxCosting\Selector'
      RowFooterColor = clHighlight
      RowFooterTextColor = clWindow
      object dbgReqLookupRequisition_str: TdxDBGridMaskColumn
        Caption = 'Requisition'
        DisableEditor = True
        Width = 146
        BandIndex = 0
      ...
      object dbgReqLookupCode_str: TdxDBGridMaskColumn
        Caption = 'Code'
        DisableEditor = True
        Width = 63
        BandIndex = 0
      ...
      object dbgReqLookupName_str: TdxDBGridMaskColumn
        Caption = 'Name'
        DisableEditor = True
        Width = 103
        BandIndex = 0
      ...
      object dbgReqLookupPOReference_str: TdxDBGridMaskColumn
      ...
      object dbgReqLookupItemsNo_int: TdxDBGridMaskColumn
        Caption = 'Items'
        DisableEditor = True
        Width = 57
        BandIndex = 0
      ...
      object dbgReqLookupTotalCost_mon: TdxDBGridCurrencyColumn
        Caption = 'Potential Cost'
        DisableEditor = True
        Width = 113
        BandIndex = 0
        RowIndex = 0
