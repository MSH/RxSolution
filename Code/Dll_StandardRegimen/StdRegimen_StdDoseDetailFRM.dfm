object frmStdDoseDetail: TfrmStdDoseDetail
  Left = 264
  Top = 229
  BorderIcons = []
  ...
  object pnlRXBackground: TPanel
    ...
    object pnlForm_Detail: TPanel
      ...
      object pnlForm_Detail_Divider: TShape
        Left = 681
        Top = 132
        Width = 1
        Height = 168
      ...
      object Panel1: TPanel
        ...
        object regLabel_01: TRzDBLabel
          ...
          DataSource = FRM_StandardRegimen
        end
      ...
      object RzDBLookupComboBox1: TRzDBLookupComboBox
        ...
        ListField = 'strengthExtraDescription_str'
        ListSource = FRM_Formulation
        NullValueKey = 16462
        ParentCtl3D = False
        ParentFont = False
        TabOrder = 0
      ...
      object RzDBLookupComboBox2: TRzDBLookupComboBox
        ...
        ListSource = FRM_RegiminInterval
        NullValueKey = 16462
        ParentCtl3D = False
        ParentFont = False
        TabOrder = 3
      ...
      object RzDBEdit3: TRzDBEdit
        ...
        Height = 22
        DataSource = FRM_StandardRegimen
        DataField = 'FrmAdministrationUnit_Str'
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -15
      ...
      object RzDBLookupComboBox3: TRzDBLookupComboBox
        ...
        ListField = 'packDescription_Str'
        ListSource = FRM_ProductPacks
        NullValueKey = 16462
        ParentCtl3D = False
        ParentFont = False
        TabOrder = 6
      ...
      object RzDBLookupComboBox4: TRzDBLookupComboBox
        ...
        KeyField = 'abbreviation_Str'
        ListField = 'abbreviation_Str'
        ListSource = FRM_RegiminInstruction
        NullValueKey = 16462
        ParentCtl3D = False
        ParentFont = False
        TabOrder = 8
      ...
      object RzDBCheckBox1: TRzDBCheckBox
        ...
        Width = 230
        Height = 21
        DataField = 'DspProductBreakPack_Bol'
        DataSource = FRM_StandardRegimen
        ValueChecked = 'True'
        ValueUnchecked = 'False'
        Caption = 'Break the product pack?'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -15
        Font.Name = 'Arial'
      ...
      object RzDBCheckBox2: TRzDBCheckBox
        ...
        ValueUnchecked = 'False'
        Caption = 
          'Automatically build the instruction sentence? [ or type in the l' +
          'ine below to switch off]'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -15
        Font.Name = 'Arial'
  ...
  object FRM_StandardRegimen: TDataSource
    DataSet = dmStdReg.qryStdRegimen
    Left = 16
    Top = 48
  end
  object FRM_Formulation: TDataSource
    DataSet = dmStdReg.qryProductFormulation
    Left = 56
    Top = 48
  end
  object FRM_ProductPacks: TDataSource
    DataSet = dmStdReg.qryProductPacks
    Left = 88
    Top = 48
  end
  object FRM_RegiminInstruction: TDataSource
    DataSet = dmStdReg.qryRegiminInstruction
    Left = 152
    Top = 48
  end
  object FRM_ICD: TDataSource
    DataSet = dmStdReg.qryICD10
    Left = 184
    Top = 48
  end
  object FRM_RegiminInterval: TDataSource
    DataSet = dmStdReg.qryRegiminInterval
    Left = 120
    Top = 48
  end
  object aclRegiminDetail: TActionList
    ...
    object actData_Post: TAction
      Category = 'Dataset'
      Caption = 'Save'
      Hint = 'Save|Save this standard regimen to the database'
      ShortCut = 16467
    ...
    object actData_Cancel: TAction
      Category = 'Dataset'
      Caption = 'Cancel'
      Hint = 'Cancel|Cancel all changes since you last saved'
      OnExecute = actData_CancelExecute
    end
    object actPrint: TAction
      Caption = 'Print'
      Hint = 'Print|Print this standard regimen'
      ShortCut = 16464
    end
  end
