object frmStdDose: TfrmStdDose
  ...
  object pnlRXBackground: TPanel
    ...
    object pnlForm_Detail: TPanel
      ...
      object pnlToolbar: TPanel
        ...
        object ElSpeedButton1: TElSpeedButton
          ...
          Color = clBtnFace
          ParentColor = False
          Action = atnViewRegimenEditHistory
          DockOrientation = doNoOrient
        end
      ...
      object dxgStandardRegimen: TdxDBGrid
        Left = 1
        Top = 62
        Width = 1044
        Height = 312
        ...
        ParentFont = False
        TabOrder = 1
        OnDblClick = actData_EditExecute
        ArrowsColor = clNavy
        ...
        IndentDesc = 10
        LookAndFeel = lfFlat
        OptionsBehavior = [edgoAutoSearch, edgoCaseInsensitive, edgoDragScroll, edgoEditing, edgoEnterShowEditor, edgoHeaderButtonClicking, edgoHorzThrough, edgoImmediateEditor, edgoMultiSelect, edgoMultiSort, edgoShowHourGlass, edgoStoreToRegistry, edgoTabs, edgoTabThrough, edgoVertThrough]
        OptionsCustomize = [edgoBandMoving, edgoBandSizing, edgoColumnMoving, edgoColumnSizing, edgoHeaderPanelSizing]
        OptionsDB = [edgoConfirmDelete, edgoSmartReload, edgoSyncSelection, edgoUseBookmarks, edgoUseLocate]
        ...
        RegistryPath = '\Software\RxSolution\1.2\Grids\Prescription\dxgStandardRegimen'
        RowFooterColor = clHighlight
        RowFooterTextColor = clWindow
        ShowGrid = False
        object dxgStandardRegimenFrmDescription_Str: TdxDBGridColumn
        ...
        object dxgStandardRegimenDspDescription_Str: TdxDBGridColumn
          Caption = 'Dispensing'
          DisableEditor = True
          Width = 427
          BandIndex = 0
        ...
        object dxgStandardRegimenFrmICDCode_Str: TdxDBGridColumn
          Caption = 'ICD'
          DisableEditor = True
          Width = 127
          BandIndex = 0
    ...
    object pnlForm_Header: TPanel
      ...
      Color = clWhite
      TabOrder = 2
      object lblProtocolHeading: TLabel
        Left = 10
        Top = -1
        Width = 150
        Height = 62
  ...
  object FRM_StdRegimen: TDataSource
    DataSet = dmStdReg.qryStdRegimen
    Left = 48
    Top = 40
  end
  ...
  object aclRegiminDetail: TActionList
    ...
    object atnViewRegimenEditHistory: TAction
      Caption = 'Regimen Edit History'
      Hint = 'Regimen Edit History'
      OnExecute = atnViewRegimenEditHistoryExecute
    end
  end
end
