object frmProtocol: TfrmProtocol
  ...
  object pnlRXBackground: TPanel
    ...
    object pnlForm_Detail: TPanel
      ...
      object dxgProtocolList: TdxDBGrid
        Left = 1
        Top = 62
        Width = 1044
        Height = 312
        ...
        IndentDesc = 10
        LookAndFeel = lfFlat
        OptionsBehavior = [edgoAnsiSort, edgoAutoSearch, edgoAutoSort, edgoCaseInsensitive, edgoDragScroll, edgoEditing, edgoEnterShowEditor, edgoHeaderButtonClicking, edgoHorzThrough, edgoImmediateEditor, edgoMultiSort, edgoShowHourGlass, edgoStoreToRegistry, edgoTabs, edgoTabThrough, edgoVertThrough]
        OptionsCustomize = [edgoBandMoving, edgoBandSizing, edgoColumnMoving, edgoColumnSizing, edgoHeaderPanelSizing]
        OptionsDB = [edgoCanNavigation, edgoConfirmDelete, edgoLoadAllRecords, edgoSmartRefresh, edgoSmartReload, edgoSyncSelection, edgoUseBookmarks, edgoUseLocate]
        ...
        PreviewFont.Color = clGray
        PreviewFont.Height = -11
        PreviewFont.Name = 'Tahoma'
        PreviewFont.Style = [fsItalic]
        RegistryPath = '\Software\RxSolution\1.2\Grids\Protocol\dxgProtocolListing'
        RowFooterColor = clHighlight
        RowFooterTextColor = clWindow
        ShowGrid = False
        ShowPreviewGrid = False
        object dxgProtocolListCode_Str: TdxDBGridColumn
          Caption = 'Code'
          DisableEditor = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clGreen
        ...
        object dxgProtocolListName_Str: TdxDBGridColumn
          Caption = 'Protocol'
          DisableEditor = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
        ...
        object dxgProtocolListIndicationCode_Str: TdxDBGridColumn
          Caption = 'ICD Code'
          DisableEditor = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clNavy
          ...
          BandIndex = 0
          RowIndex = 0
          FieldName = 'IndicationCode_Str'
        end
        object dxgProtocolListIndication_Str: TdxDBGridColumn
          ...
          BandIndex = 0
          RowIndex = 0
          FieldName = 'Indication_Str'
        end
        object dxgProtocolListGroupCode_Str: TdxDBGridColumn
          Caption = 'Group Code'
          DisableEditor = True
          Visible = False
          Width = 121
  ...
  object aclProtocol: TActionList
    ...
    object atnCopyProtocol: TAction
      Caption = 'Copy Protocol'
      OnExecute = atnCopyProtocolExecute
    end
  end
  ...
  object PopupMenu1: TPopupMenu
    Left = 48
    Top = 72
    object CopyProtocol1: TMenuItem
      Action = atnCopyProtocol
    end
  end
end
