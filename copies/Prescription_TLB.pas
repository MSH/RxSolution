...
// *********************************************************************//
  IRX = interface(IDispatch)
    ...
    procedure Edit(const _id: WideString; const _userRights: WordBool); safecall;
    ...
    procedure Protocols(const _userRights: WordBool); safecall;
    procedure StandardDose(const _userRights: WordBool); safecall;
...
// *********************************************************************//
  IRXDisp = dispinterface
    ...
    procedure Edit(const _id: WideString; const _userRights: WordBool); dispid 3;
    ...
    procedure Protocols(const _userRights: WordBool); dispid 8;
    procedure StandardDose(const _userRights: WordBool); dispid 9;
